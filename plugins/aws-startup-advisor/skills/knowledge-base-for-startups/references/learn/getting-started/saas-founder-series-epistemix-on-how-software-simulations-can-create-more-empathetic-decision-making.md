---
source_url: https://aws.amazon.com/startups/learn/saas-founder-series-epistemix-on-how-software-simulations-can-create-more-empathetic-decision-making
...
In 2000, world-leading epidemiologist [Donald S. Burke](https://www.linkedin.com/in/donald-s-burke-652b3b4/) was heading infectious disease research for the US military when he realized that decision makers didn't have the tools they needed to understand what the future of an epidemic might look like.

To address this gap in the market, Burke, Cordier, and [John Grefenstette](https://www.linkedin.com/in/john-grefenstette-73b74a51/) founded [Epistemix](https://www.epistemix.com/), an agent-based modeling platform paired with a synthetic, statistically accurate population of the United States.

With Epistemix's software, data scientists can gain insights by running experiments—controlling variables like climate or economic changes—in a statistically accurate virtual world, exploring how large human populations might behave given different circumstances.

![Figure 1. Users can immediately start running models on the platform's synthetic population of the entire US](https://d22k7geae6sy8h.cloudfront.net/files/653bc3c8bfea630008278c3c/8lo8orsx9-8ljn1rkmg-Synthetic-Population-Mockup.jpg)
...
During the COVID-19 pandemic, the Epistemix team used their software to help clients in the global events industry—including [CES](https://www.ces.tech/), [IMTS](https://www.imts.com/), [the Javits Center](https://javitscenter.com/), and other organizations—make better decisions about how and when to bring people back together.
...
![Figure 2. Simulating housing equity with a classic Schelling model](https://d22k7geae6sy8h.cloudfront.net/files/653bc3eabfea630008278c3d/8lo8osjn7-8ljn1s6js-Schelling-Model-Screenshot.jpg)
...
[AWS SaaS Factory](https://aws.amazon.com/partners/saas-factory?utm_source=apn&utm_medium=blog&utm_campaign=sf_home) can help startups at any stage of their SaaS journey. Whether you're looking to build new products, migrate existing applications, or optimize SaaS solutions on AWS, we can help. Visit the [AWS SaaS Factory Insights Hub](https://aws.amazon.com/partners/saas-factory?utm_source=apn&utm_medium=blog&utm_campaign=in_hub#AWS_SaaS_Factory_Insights_Hub) to discover more technical and business content and best practices.

Reach out to your account representative to inquire about engagement models and to work with the AWS SaaS Factory team.

[Sign up for our AWS Partner communications to stay informed](https://partners.awscloud.com/SaaS.html?utm_source=apn&utm_medium=blog&utm_campaign=opt_in) about the latest SaaS on AWS news, resources, and events.
