---
source_url: https://aws.amazon.com/startups/learn/yulu-is-electrifying-indias-streets-with-aws
...
With AWS, Yulu built a platform that could meet the demands of a rapidly growing, real-world fleet. The company relied on [Amazon Elastic Compute Cloud](https://aws.amazon.com/ec2) (Amazon EC2) to scale compute power and later migrated to [AWS Graviton](https://aws.amazon.com/ec2/graviton/) processors for a boost in performance and energy efficiency. The shift was seamless and the results were immediate.
...
The Indian company is just one of thousands of startups from across the world that are innovating and growing with AWS. More than 85 percent of the startups listed on the [2025 CNBC Disruptor 50](https://www.cnbc.com/2025/06/10/2025-cnbc-disruptor-50-see-the-full-list-of-companies.html) are building on our infrastructure, with many accessing solutions cost-effectively through [AWS Activate](https://aws.amazon.com/activate/activate-landing/). From technical support to architecture guidance, the program provides startups with the resources they need to build, launch, and scale. Since inception in 2013, AWS Activate has also provided more than $8 billion in [AWS Activate Credits](https://aws.amazon.com/startups/credits) to founders, enabling them to offset investment in infrastructure. Find out more about [AWS Activate](https://aws.amazon.com/activate/activate-landing/) today.
