---
source_url: https://aws.amazon.com/startups/learn/grow-your-startup-faster-with-automated-decision-making
...
Automated decisions rely on a set of constraints, including business rules, that guide the decision-making tool's interpretation of data. While basic decision-making tools may be based on if/then logic—for example, choosing from a limited set of possible decisions based on which data conditions are met—many automated decision-making (ADM) solutions now use algorithms, machine learning, and [AI](/startups/generative-ai/) to automate complex decisions that have typically required human intervention.
