---
source_url: https://aws.amazon.com/startups/learn/how-stigma-scaled-their-hope-delivery-app-with-the-aws-impact-accelerator
...
"Our perception of the world is based on the lived experience we have and the stories we consume," explains STIGMA founder and chief executive officer (CEO) Ariana Vargas, alluding to [The Danger of a Single Story](https://www.youtube.com/watch?v=D9Ihs241zeg). She founded STIGMA to bridge the gap between mental health narratives and the lived experiences of the people who struggle with them.
...
As their user base continues to grow, STIGMA is leveraging lessons from their participation in the [AWS Impact Accelerator Latino Founders cohort](https://aws.amazon.com/blogs/startups/announcing-the-startups-selected-for-the-aws-impact-accelerator-latino-founders-cohort/) to scale their ability to share messages of hope by incorporating artificial intelligence (AI) and machine learning (ML) into their platform.
...
Learn more about how Stigma is proving what's possible in the [AWS Founder Spotlight: STIGMA video](https://www.youtube.com/watch?v=qv5HpqC08HA).
